...
<form name="jojn" method="post" onsubmit="return join_go()">
...
<div class="joinContainerEmail" >
	...
	<div class="emailContainer" >
		...
		<input type="button" value="메일인증" onclick="email_ok(email1.value+'@'+email2.value)" class="mailBtn">
		<input type="hidden"  id ="e_check" name="e_check" value="n" style="width:20px;">
		
		<input type="hidden" id = "email" name="email" >
		<input id="num2" name="num2" placeholder="인증번호를 입력하세요" class="mailInput2" required>
		<input type="button" value="인증" onclick="email_confirm()" class="mailBtn">
	</div>
...
<div><button class="joinOkBtn">회원가입</button></div>
</form>
