...
<center>
	...
	<div class="introduce">
		<div class="introduceItem">가입하신 방법에 따라 아이디 찾기가 가능합니다.</div>
	</div>
	
	<div style="height:50px;"></div>
	<form method="post" onsubmit="return find_id_go()">
	<div class = "findContainer">
		...
		<div class="container2">
			...
			<span  id="personalRadio">
				<input type="radio" id ="findMethodPhone" name="findMethod"   onclick="method_ch('phone')">전화번호
