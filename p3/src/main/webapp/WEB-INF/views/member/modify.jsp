...
<form name="modify" method="post" onsubmit="return modify_go()">
<div style="height:100px;width:1800px;">
...
<div class="modifyContainerInfo">
	...
	<div><input type="password" id ="pass" name="pass" class="modifyInput" value="${m.pass }" required></div>
</div>
<div class="modifyContainerInfo">
	<div class="memberType">비밀번호 확인</div>
	<div><input type="password" id ="pass2" class="modifyInput" value="${m.pass }" onchange="passCheck(this.value)" required></div><div id="passResult"></div>
</div>
<div class="modifyContainerInfo">
